...
if [ "$varError" = "[Error] La resolución especificada es incorrecta." ];
 then echo "./tp0 -r 54x45d corrio OK";
 else
...
if [ "$varError" = "[Error] Formato incorrecto del número complejo para el centro." ];
...
if [ "$varError" = "[Error] Formato incorrecto como nombre de archivo de salida." ];
...
if [ "$varError" = "[Error] Extensión incorrecta para el archivo de salida." ];
